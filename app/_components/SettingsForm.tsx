        ...
        <div className="space-y-3">
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              ...
              name="reminder_mode"
              value="fixed"
              defaultChecked={user.reminder_mode === 'fixed'}
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              ...
              name="reminder_mode"
              value="ai"
              defaultChecked={user.reminder_mode === 'ai'}
              className="mt-0.5 accent-zinc-800"
            />
            <div>
              <div className="text-sm font-medium">AI / Predictive</div>
              <div className="text-xs text-zinc-500">Gemini estimates prep time per event type</div>
            </div>
          </label>
        </div>
      </div>
